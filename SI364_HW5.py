...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/matlefkofskyHW5"
...
app.config['MAIL_PASSWORD'] = "SI364Mat"
...
class TweetForm(FlaskForm):
    ...
    email =StringField("What is the email address you use to sign in on Twitter?", validators=[Required()])
